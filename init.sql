CREATE DATABASE /*!32312 IF NOT EXISTS*/ `garageVincentParrot` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `contact` VALUES (3,176,'directeur','j\'aimerais parler au directeur'),(4,176,'Renault clio','je veux cette voiture'),(5,176,'Toyota yaris','blabla'),(7,170,'aegag','aegva'),(8,167,'Toyota yaris','la voiture est dispo ?'),(9,167,'bonjour','ici vincent');
